...
const About = () => (
  <div className="about show-on-scroll">
    ...
    <p>
      ...
      horror. I currently manage a full-stack development team focusing on
      writing modular, scalable code and perpetuating an inclusive, supportive
      culture. As a developer, I have a passion for building seamless
    ...
    <p>
      ...
      personally and professionally. I also enjoy reading, cooking good vegan
      food, and taking long walks on the beach. And I am always looking to
      connect! You can reach me most easily on{" "}
      <a
      ...
      , but feel free to shoot me an email{" "}
      <a
