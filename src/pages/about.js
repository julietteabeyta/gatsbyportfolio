...
const About = () => (
  <div className="about show-on-scroll">
    ...
    <p>
      ...
      And I am always looking to connect! You can reach me most easily on <a href="https://twitter.com/julietteabeyta" target="_blank" rel="noopener noreferrer">twitter</a>, but feel free to shoot me an email <a href="mailto:julietteabeyta@gmail.com" rel="noopener noreferrer">here.</a>
    </p>
  </div>
)
